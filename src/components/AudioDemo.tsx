...
const AudioDemo: React.FC = () => {
  return (
    <section className="pt-4 pb-16 relative overflow-hidden"> {/* Reduced top padding significantly */}
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-base text-aqua-700 max-w-xl mx-auto mb-6"> {/* Reduced margin */}
